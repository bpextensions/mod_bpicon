...
var app = {
    ...
    js: function(){
        ...
        return gulp.src([
            'modules/mod_bpicon/.dev/js/**/*.js'
        ])
        .pipe(concat('module.js'))
        .pipe(gulp.dest('modules/mod_bpicon/assets/'))
        .pipe(uglify({
            output: {
                comments: /^!/
            }
    ...
    sass: function () {
        return gulp.src([
            'modules/mod_bpicon/.dev/sass/**/*.scss',
            'modules/mod_bpicon/.dev/sass/**/*.sass'
        ])
        .pipe(sass({
